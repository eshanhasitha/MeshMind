...
export const evaluateAlerts = async (): Promise<void> => {
  ...
  try {
    ...
    /*
     Persistent breach:
     update existing active alert only.
     Do NOT send duplicate fired webhook.
    */
    if (
    ...
    */
    if (
      ...
      await sendWebhookEvent("alert.fired", {
        event: "alert.fired",
    ...
    */
    if (
      ...
      await sendWebhookEvent("alert.resolved", {
